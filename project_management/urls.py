...
urlpatterns = [
    ...
    path('project_info_handle/', include('project_info_handle.urls', namespace='project_info_handle')),
    ...
    path('equipment_procurement_detail/', include('equipment_procurement_detail.urls')),
